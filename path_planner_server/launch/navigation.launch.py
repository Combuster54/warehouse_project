...
def generate_launch_description():
    ...
    rviz_file = os.path.join(get_package_share_directory(path_planner_server_pkg),'rviz','pathplanning.rviz')
    #~~~~~~~~~~~~~~~~~~~~~~~~path config files~~~~~~~~~~~~~~~~~~~~~~~~~~~+
    ...
    map_file_path = os.path.join(get_package_share_directory(map_server_pkg),'config','warehouse_map_real.yaml')
