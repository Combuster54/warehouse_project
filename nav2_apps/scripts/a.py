...
class NavigationClass(Node):
    ...
    def set_loading_pose(self):
        ...
        self.set_loading_position.pose.position.x = -2.022
        self.set_loading_position.pose.position.y = -5.0747
        self.set_loading_position.pose.orientation.x = 0.0
        self.set_loading_position.pose.orientation.y = -0.0
        self.set_loading_position.pose.orientation.z = -0.9220
        self.set_loading_position.pose.orientation.w = -0.3870
